...
short div_2_minutes( double numerator, double divisor )
{
 double res, atres;
...
double degrees_2_rads( short degs, short mins )
{
 double degrees;
...
void sidereal_2_angular( TIM *tp, short *degs, short *mins, short *secs )
{
 short side;
...
short calc_ascendant( DEG_MIN *lat )
{
