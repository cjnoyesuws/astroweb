...
short bad_time( TIM *t, short mode )
{
 short max;
...
double calc_sidereal_t( DATES *dp, short hours, short minutes )
{
 double side, t;
...
void sidereal_time( DATES *dp, short hours, short min,  DEG_MIN *longitude,
...
short noon_date( DATES *dp, DATES *noon_date, TIM *noon, TIM *tp,
					     short local_hours, short local_min )
{
 short hours = 0;
 short roll=0;
 short err=0;
