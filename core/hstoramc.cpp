...
extern short  regio_cusp( int house, char dir );
extern short  companus_cusp( int house, char dir );
...
double min_medcoeli_to_ramc( short  mc )
{
 double mcr;
...
double comp_house_to_ramc( int house, short  hs_min, DEG_MIN *lat, double iramc )
{
 short  r;
 double res, t, d;
...
double plac_house_to_ramc( int house, short  hs_min, DEG_MIN *lat, double iramc )
{
 short  r, x_min;
 double res, t, d;
...
double koch_house_to_ramc( int house, short  hs_min, DEG_MIN *lat, double iramc )
{
 short  r;
 double res, t, d;
...
double regio_house_to_ramc( int house, short  hs_min, DEG_MIN *lat, double iramc )
{
 short  r;
 double res, t, d;
...
double morinus_house_to_ramc( int house, short  hs_min, DEG_MIN *lat, double iramc )
{
 short  r;
 double res, t, d;
...
double house_to_ramc( int house, short  hs_min, DEG_MIN *lat, int hs_sys )
{
 double d, drmc;
 static short ev[] = { 0, 0, -1800, -3600, -5400, -7200, -9000, -10800, -12600,
       -14400, -16200, -18000, -19800  };
 static short  mv[] = { 0, -7200, -9000, -10800, 10800, 9000, 7200, 5400, 3600,
       1800, 0, -1800, -3600 };
 short  m;
