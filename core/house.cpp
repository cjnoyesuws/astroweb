...
/* function to flip short tes d2m(180) if dir is south */

short  flip_mins( short  mins, char dir )
{
...
short compare_house_cusps( short  first, short  second, short mins  )
{
 if ( second - first > 0 ) {
    first += d2m(2);
    second += d2m(2);
...
short house_cusp_intercept( short  mins, short house )
{
 short test;
