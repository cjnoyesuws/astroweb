...
short test_aspect( short deg1, short deg2 )
{
 short dif, orb;
...
short find_aspect( short deg1, short deg2, short *aspect, int maxiorb )
{
 short i, orb;
...
short do_aspect( AS_INF *pla_ptr, short planet, AS_INF *asptr,
		   short maxorb, unsigned int mode, short maxp, int startp )
{
 short pno, aspects;
 short aspn = 99;
 short orb = NO_ASPECT;
...
void process_aspects( AS_INF  *planet, AS_INF  *sub, unsigned int mode, int chart_code )
{
 ASPEC *asp;
 AS_INF *pl;
 short  pno, aspects;
 short   maxorb, xmaxorb;
 short    maxp, startp;
 unsigned int   hm = mode & HOUSES;
