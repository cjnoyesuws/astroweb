...
void make_moon_series( short moon, unsigned int mode, short year )
{
 short i;
 short md;
...
void do_full_progr( AS_DATA *bdata, AS_INF *binf, AS_INF *pinf,
		   unsigned int bmode, unsigned int pmode, short house_proc, DATA_PACKET *dpk )
{
