...
const char *sign_str( short sign )
{
...
const char *planet_str( short planet )
{
...
const char *number_str(short number )
{
...
const char *aspect_str( short aspect )
{
...
void print_cusps(FILE *stream, short *house_cusps )
{
 short x;
 char b1[15], b2[15];
