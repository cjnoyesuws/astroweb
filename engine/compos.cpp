...
void do_compos_sum_calc1( AS_INF *info, AS_INF *partner, unsigned int mode )
{
...
void do_compos_sum_calc2( AS_INF *info, AS_INF *partner, unsigned int mode )
{
...
void do_compos( AS_INF *you, AS_INF *partner, short *array, unsigned int mode, int year )
{
 AS_INF *ptr, *ptr2;
 short i;
 long min;
...
{
 unsigned int mask = ( 0xffff ^ ( BASE_MID | FULL_MID | MID_ASPECT | ASPECTS ) );
 short flag;
 DATA_PACKET xdp;
 TIM st;
