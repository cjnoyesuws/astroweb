...
short midpoint( short min1, short min2 )
{
 short max, min, dif;
...
void do_mid_aspect( MIDPT *mid_ptr, short planet, AS_INF *asptr,
                       short maxp, unsigned int mode, int same )
{
 short pno, aspects;
 short aspn;
 short orb;
...
void do_basic_midpts( AS_INF *chart, unsigned int mode )
{
 short mid;
...
void do_full_midpoints( AS_INF *chart1, AS_INF *chart2, unsigned int mode )
{
 short no, planet, numpt;
 MIDPT *ptr;
 AS_INF *inf;
 short maxp;
 unsigned int amode = mode;
...
void calc_midpoints( AS_INF *main, AS_INF *alt, int pno, int maxp1, int maxp2, unsigned int mode, short &nomid, MIDPT **midptr, int same )
{
 int mc;
 if ( same )
    mc = maxp2-pno;
...
void do_main_full_midpoints( AS_INF *main, short maxp1, AS_INF *alt, short maxp2, unsigned int mode, int same )
{
 AS_INF *infptr;
 int i;
