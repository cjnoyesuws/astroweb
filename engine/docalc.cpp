...
short critical_degree( short deg, short sign )
{
...
void misc_calc( AS_INF *ptr, unsigned int code, short year )
{
...
void do_calc( AS_INF *info, AS_DATA *data, unsigned int mode, short house_proc,
						     DATA_PACKET *dpk )
{
 short i;
 short min;
